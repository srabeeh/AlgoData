...
namespace LinkedListTests.SingleList
{
    ...
    public class Find
    {
        ...
        [Test, TestCaseSource("_find_Missing_Test_Cases")]
        ...
        [Test, TestCaseSource("_find_Found_Test_Cases")]
        ...
        static object[] _find_Missing_Test_Cases =
                     {
        ...
        static object[] _find_Found_Test_Cases =
                     {
